...
namespace _01Prototype
{
    class StartUp
    {
        static void Main(string[] args)
        {
            ...
            sandwichMenu["BLT"] = new Sandwich("Wheat", "Bacon", "", "Tomato");
            sandwichMenu["PB&J"] = new Sandwich("White", "ham", "Yellow", "Onion");
            sandwichMenu["Turkey"] = new Sandwich("Rye", "Turkey", "Swiss", "Lettuce, Onion, Tomato");

            sandwichMenu["LoadedBLT"] = new Sandwich("Wheat", "Bacon", "American", "Lettuce, Tomato, Onion, Olives");
